        ...
        <>
            ...
            <section className='min-h-screen bg-text-white flex flex-col content-center text-justify flex-wrap lg:p-25 gap-10 '>
                ...
                <p className='text-xl lg:text-2xl leading-13'>De acordo com um Índice de Privação On-Line feito pela PwC, 33,9 milhões de brasileiros não estão conectados à internet, sendo a maioria deles homens, idosos, não alfabetizados e das classes C, D e E.
                    ...
                    <div className='flex flex-row justify-center md:justify-between mt-20 items-center w-lg md:w-2xl lg:w-5xl xl:w-auto flex-wrap xl:flex-nowrap '>
                ...
                <p className='text-xl lg:text-2xl leading-13'>Também há a pretensão de incluir posteriormente leitura por voz e tradução para libras; além de tour guiado com Blocking Modal Walkthrough, que são curtas animações que indicam o que deve ser feito, e só desaparecem da tela após a conclusão da etapa.</p>
